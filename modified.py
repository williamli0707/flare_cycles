...
def main(BIN_LENGTH, NUM_DAYS_INPUT):
    ...
    assert os.path.exists('./data/time_nd' + str(BIN_LENGTH) + '_' + str(NUM_DAYS_INPUT) + '.npz')
    data = np.load('./data/time_nd' + str(BIN_LENGTH) + '_' + str(NUM_DAYS_INPUT) + '.npz', allow_pickle=True)
    inputs = data['inputs']
